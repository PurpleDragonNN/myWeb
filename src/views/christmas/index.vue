<template>
  <div class="wrapper">
    ...
    <div class="animation-box">
      <h2 class="holidays-title">Dorana,Merry Christmas!</h2>
      <div class="scene">
        <div class="xmas-tree">
          <div class="tree-star">
          </div>
